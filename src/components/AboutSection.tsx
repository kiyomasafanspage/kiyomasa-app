...
export default function AboutSection() {
  ...
  const features = [
    { icon: "🤝", title: a.f1t, desc: a.f1d },
    { icon: "🎭", title: a.f2t, desc: a.f2d },
    { icon: "🎯", title: a.f3t, desc: a.f3d },
    { icon: "🦍", title: a.f4t, desc: a.f4d },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              {a.p1}{" "}
              <span className="text-[#c8a94b] font-bold">{a.donationAmt}</span>{" "}
              {a.p2}
            </motion.p>
        ...
        >
          ...
          <div className="text-center">
            <p className="text-3xl font-black text-[#c8a94b]">
              {a.donationAmt}
            </p>
